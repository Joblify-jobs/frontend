...
import { Loader2, ShieldCheck, UserPlus, Mail, Lock, User, ChevronRight, Eye, EyeOff } from 'lucide-react';
        ...
        <Card className="border-gray-100 text-gray-900 shadow-2xl p-4 rounded-[3rem] bg-white">
          <CardHeader className="space-y-2 text-center pb-4">
            ...
            <div className="space-y-1">
              <CardTitle className="text-3xl font-black tracking-tighter">Join Joblify</CardTitle>
              <CardDescription className="text-gray-400 font-bold uppercase tracking-[0.2em] text-[8px]">
                Access the world's most elite tech roles.
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent>
              ...
              >
                {isLoading ? <Loader2 className="animate-spin" size={20} /> : (
                   <span className="flex items-center gap-2">
                     Create Membership <ChevronRight size={18} className="group-hover:translate-x-1 transition-transform" />
                   </span>
                )}
              </Button>
            </form>
            ...
            <div className="mt-6 text-center text-[10px] text-gray-400 font-bold uppercase tracking-widest">
              Already a member?{" "}
              <Link href="/login" className="text-[#10B981] font-black hover:underline tracking-tighter ml-1">
                Unlock Access
              </Link>
            </div>
          </CardContent>
